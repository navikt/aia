  ...
  return (
    <>
      <BodyShort className="blokk-s">
        Du kan når som helst søke om arbeidsavklaringspenger hvis arbeidsevnen din er redusert med minst 50 prosent. Du
        kan tidligst få utbetalt arbeidsavklaringspenger fra og med den dagen du søker.
      </BodyShort>
      ...
      <BodyShort className="blokk-s">
        Hvis du ikke har oversikt over hvor lenge du har vært sykmeldt, må du være oppmerksom på at sykepengene dine kan
        ta slutt før du tror.
      </BodyShort>
      ...
      <ul>
        <li>
          <a className="lenke" href="https://www.nav.no/no/NAV+og+samfunn/Om+NAV/Saksbehandlingstider+i+NAV?kap=398578">
