        ...
        <div className={"valg"}>
          ...
          >
            ...
            <ul className="feedback-grunner">
              <li>
                <button onClick={() => handleFeedback("nei - visste det fra før")}>{tekst("gammeltNytt")}</button>
              </li>
              <li>
                <button onClick={() => handleFeedback("nei - forstår ikke innholdet")}> {tekst("forstodIkke")}</button>
              </li>
              <li>
                <button onClick={() => handleFeedback("nei - føles ikke viktig")}> {tekst("uviktig")}</button>
              </li>
              <li>
                <button onClick={() => handleFeedback("nei - andre grunner")}>{tekst("andreGrunner")}</button>
              </li>
            </ul>
          </Popover>
          <span className="feedback-space" aria-hidden="true">
