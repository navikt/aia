...
function Kort2() {
  return (
    <div className="kortflate">
      <div>
        <Heading size="medium">I løpet av den første tiden vil du jobbe tett sammen med en veileder fra NAV.</Heading>
        <Detail size="small" className="blokk-xs">
          2 av 5
        </Detail>
    ...
    <div className="kortflate">
      <div>
        ...
        <BodyShort className={"blokk-xs"}>
          ...
          arbeidsmål avhengig av hva du trenger. Veileder kan for eksempel bistå rundt det å søke stillinger og tilby
          hjelp på veien til arbeid.
        </BodyShort>

        <BodyShort className={"blokk-xs"}>
          Veiledere har dessverre <strong>ikke</strong> mulighet til å besvare på spørsmål som handler om behandling av
          søknader eller utbetalinger av dagpenger.
        </BodyShort>
        ...
        <BodyShort className={"blokk-m"}>
          ...
          <Link
            ...
            onClick={() =>
              loggLenkeKlikk("Går til STO fra 14a onboarding kort", "https://mininnboks.nav.no/sporsmal/skriv/ARBD")
            }
          >
            skriv til oss
          </Link>{" "}
          ...
          <Link
            ...
            onClick={() =>
              loggLenkeKlikk("Går til Chat fra 14a onboarding kort", "https://www.nav.no/person/kontakt-oss/chat/")
            }
          >
            chat
          </Link>
  ...
  return (
    <div className="kortflate">
      <div>
        ...
        <BodyShort className={"blokk-xs"}>
          {servicegruppe === Servicegruppe.IKVAL ? (
            <>
              ...
              . Det betyr at NAV basert på informasjonen du har gitt oss, har vurdert hvilken støtte som kan passe for
              deg.
            </>
          ) : (
        ...
        <BodyShort className={"blokk-m"}>Dette brevet er ikke et svar på en eventuell søknad om dagpenger.</BodyShort>
      </div>
  ...
  return (
    <div className="kortflate">
      <div>
        ...
        <BodyShort className={"blokk-xs"}>
          Du kan når som helst kontakte veileder ved å bruke dialogen som vises på slutten av denne introduksjonen.
        </BodyShort>
      </div>
