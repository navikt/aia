  ...
  return (
    <div className="kortflate">
      <div>
        ...
        <BodyShort className={"blokk-xs"}>
          In order to be registered as a jobseeker, it's important that you respond to inquiries and remember to submit
          the employment status form before the deadline.
        </BodyShort>

        <BodyShort className={"blokk-xs"}>
          We have made a brief summary of the most important things you should know about employment status forms and
