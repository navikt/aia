    ...
    <div className="kortflate">
      <div>
        ...
        <BodyShort className={"blokk-xs"}>
          NAV has made an assesement of your answers, and it seems you have good chances of getting a job on your own.
        </BodyShort>
        ...
        <BodyShort>
          As a rule of thumb, NAV will not make contact with you during the first 12 weeks after you registered as
          unemployed.
        </BodyShort>
      </div>
      <Feedback id={"Introkort14A-en-01"} />
    </div>
  );
}
...
function Kort2() {
  ...
  return (
    <div className="kortflate">
      ...
      <Feedback id={"Introkort14A-en-02"} />
    </div>
  );
}
  ...
  return (
    <div className="kortflate">
      <div>
        ...
        <BodyShort className={"blokk-xs"}>
          The job of a counselor is to answer questions, and to offer help and support with getting you back to work.
        </BodyShort>
      ...
      <Feedback id={"Introkort14A-en-03"} />
    </div>
  );
}
  ...
  return (
    <div className="kortflate">
      <div>
        ...
        <BodyShort className={"blokk-xs"}>You can get help from a counselor before 12 weeks have passed.</BodyShort>

        <BodyShort className={"blokk-xs"}>
          You will then have to reach out to a counselor by using the dialogue at the end of this introduction.
        </BodyShort>

        <BodyShort className={"blokk-m"}>You may contact us right away, or give it a shot on your own first.</BodyShort>
      </div>
      <Feedback id={"Introkort14A-en-04"} />
    </div>
  );
}
