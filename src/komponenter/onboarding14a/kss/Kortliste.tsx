    ...
    <div className="kortflate">
      <div>
        ...
        <BodyShort className={"blokk-xs"}>
          Vi har gjort en vurdering av svarene dine, og vi tror at du har gode muligheter til å skaffe deg jobb på
          egenhånd.
        </BodyShort>
        ...
        <BodyShort>
          NAV tar som hovedregel ikke kontakt i forbindelse med hjelp til jobbsøking de første 12 ukene etter at du
  ...
  return (
    <div className="kortflate">
      <div>
        ...
        <BodyShort className={"blokk-xs"}>
          En veileder sin oppgave er å besvare spørsmål, bistå rundt det å søke stillinger og tilby hjelp på veien til
          arbeid.
        </BodyShort>

        <BodyShort className={"blokk-xs"}>
          Veiledere kan <strong>ikke</strong> svare på spørsmål om søknader, behandling av søknader eller utbetalinger
          av dagpenger.
        </BodyShort>
  ...
  return (
    <div className="kortflate">
      <div>
        ...
        <BodyShort>
          Du kan gi oss beskjed om at du ønsker hjelp nå med en gang, eller se litt an hvordan du syns jobbsøkingen din
          går før du tar kontakt.
        </BodyShort>
      </div>
