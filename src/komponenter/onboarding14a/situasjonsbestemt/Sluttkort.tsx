...
const TEKSTER: Tekster<string> = {
  ...
  en: {
    ...
    ingressForEgenvurdering: "We usually send the letter within a few weeks. If it takes longer, we will get in touch.",
...
function Sluttkort() {
  ...
  const har_mottatt_egenvurdering_kvittering = hentEllerSettFraBrowserStorage(HAR_MOTTATT_EGENVURDERING_KVITTERING, "");
